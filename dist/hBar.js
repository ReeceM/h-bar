  ...
  banner_createClass(Banner, [{
    ...
    value: function dismissibleButton() {
      ...
      var dismiss = newElement('button', {
        classes: "hb-flex hb-p-1 hb-rounded-md ".concat(this.theme.dismiss, " hover:hb-text-white hover:hb-bg-gray-800 focus:hb-outline-none focus:hb-bg-gray-800")
      });
